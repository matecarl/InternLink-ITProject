...
namespace InternLink.Migrations
{
    ...
    [Migration("20250102164913_Internships FK Company Link")]
    partial class InternshipsFKCompanyLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternLink.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("InternLink.Models.CompanyProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternLink.Models.Internship", b =>
                {
                    b.HasOne("InternLink.Models.CompanyProfile", "CompanyProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("InternLink.Models.Swipe", b =>
                {
                    b.HasOne("InternLink.Data.ApplicationUser", null)
                        .WithMany("Swipes")
